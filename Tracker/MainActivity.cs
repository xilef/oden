...
namespace Tracker
{
    ...
    public class MainActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            newUserBtn.Click += NewUserRegister;
        }
        ...
        { 
            ...
            {
                var user = DBHandler.Instance.getUser(userNameText.Text, passwordText.Text);
        ...
        private void NewUserRegister(object s, EventArgs e)
        {
